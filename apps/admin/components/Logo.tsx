...
// not a transparent cutout) so they're for placement on this app's `bg-brand-navy`/`bg-navy-800`
// surfaces only; `light` is the one asset the kit supplied for a light/white background. There is no
