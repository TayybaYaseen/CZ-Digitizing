...
// login/2fa-confirm/verify-session. Not imported directly since apps/api isn't a workspace
// dependency of apps/admin (backend internals stay backend-internal); kept in sync by hand.
...
// restore effect below runs) and redirect a legitimately logged-in admin to /login every time.
